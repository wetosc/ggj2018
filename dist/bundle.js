...
module.exports = __webpack_require__(/*! /home/eugenius/projects/ggj2018/src/main.js */332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__states_Menu__ = __webpack_require__(/*! ./states/Menu */ 345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__states_Credits__ = __webpack_require__(/*! ./states/Credits */ 346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config__ = __webpack_require__(/*! ./config */ 347);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
  constructor() {
    ...
    const width = docElement.clientWidth > __WEBPACK_IMPORTED_MODULE_9__config__["a" /* default */].gameWidth ? __WEBPACK_IMPORTED_MODULE_9__config__["a" /* default */].gameWidth : docElement.clientWidth;
    const height = docElement.clientHeight > __WEBPACK_IMPORTED_MODULE_9__config__["a" /* default */].gameHeight ? __WEBPACK_IMPORTED_MODULE_9__config__["a" /* default */].gameHeight : docElement.clientHeight;
    ...
    this.state.add('Credits', __WEBPACK_IMPORTED_MODULE_8__states_Credits__["a" /* default */], false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__code_Map__ = __webpack_require__(/*! ../code/Map */ 341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sprites_Ship__ = __webpack_require__(/*! ../sprites/Ship */ 342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__code_UI__ = __webpack_require__(/*! ../code/UI */ 343);
/* globals __DEV__ */
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    ...
    create() {
        ...
        this.map = new __WEBPACK_IMPORTED_MODULE_1__code_Map__["a" /* default */](this.game.rnd, {
    ...
    createPlayer() {
        this.ship = new __WEBPACK_IMPORTED_MODULE_2__sprites_Ship__["a" /* default */]({
            game: this.game,
            map: this.map,
            asset: "ship"
        });
    ...
    createKeys() {
        let upKey = game.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.UP);
        upKey.onDown.add(this.onUpKey, this);
        let downKey = game.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.DOWN);
        downKey.onDown.add(this.onDownKey, this);
    }

    createUI() {
        let ui = new __WEBPACK_IMPORTED_MODULE_3__code_UI__["a" /* UI */]({ game: this.game });
        ui.delegate = this;
    ...
    generateMap() {
        ...
        // if (this.wraps % 3 == 0) {
        let newShip = new __WEBPACK_IMPORTED_MODULE_2__sprites_Ship__["a" /* default */]({
            game: this.game,
            map: this.map,
...
class Map {
    ...
    infoForLevel(level) {
        ...
        switch (level) {
            case 1:
                res = { dist: 5, rocks: 1 };break;
            case 2:
                res = { dist: 5, rocks: 2 };break;
            case 3:
                res = { dist: 4, rocks: 2 };break;
            case 4:
                res = { dist: 4, rocks: 3 };break;
            case 5:
                res = { dist: 4, rocks: 4 };break;
            case 6:
                res = { dist: 4, rocks: 4, speed: 1 };break;
            case 7:
                res = { dist: 4, rocks: 4, speed: 2 };break;
            case 8:
                res = { dist: 4, rocks: 4, speed: 3 };break;
            default:
                res = { dist: 5, rocks: 1 };break;
        }
        return res;
...
/*!************************!*\
  !*** ./src/code/UI.js ***!
  \************************/
/*! exports provided: UI, UIData */
/*! exports used: UI, UIData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = UIData;
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    ...
    createText() {
        let strings = ['Sound:', '"Destruction, Wooden, A.wav" by InspectorJ of Freesound.org', '"Master of the Feast" Kevin MacLeod (incompetech.com)\n' + 'Licensed under Creative Commons: By Attribution 3.0 License\n' + 'http://creativecommons.org/licenses/by/3.0/'];
